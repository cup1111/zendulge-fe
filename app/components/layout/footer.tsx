      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link to="/deals" className="hover:text-pure-white transition-colors">
                  Find Deals
                </Link>
              </li>
              <li>
                <a href="#how-it-works" className="hover:text-pure-white transition-colors">
                  How It Works
                </a>
              </li>
              <li>
                <a href="#gift-cards" className="hover:text-pure-white transition-colors">
                  Gift Cards
                </a>
              </li>
              <li>
                <a href="#reviews" className="hover:text-pure-white transition-colors">
                  Reviews
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="#list-business" className="hover:text-pure-white transition-colors">
                  Register Your Business
                </a>
              </li>
              <li>
                <a href="#pricing" className="hover:text-pure-white transition-colors">
                  Pricing
                </a>
              </li>
              <li>
                <a href="#payments" className="hover:text-pure-white transition-colors">
                  Payments
                </a>
              </li>
              <li>
                <a href="#support" className="hover:text-pure-white transition-colors">
                  Support
                </a>
              </li>
              <li>
                <a href="#success-stories" className="hover:text-pure-white transition-colors">
                  Success Stories
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="#about" className="hover:text-pure-white transition-colors">
                  About Us
                </a>
              </li>
              <li>
                <a href="#contact" className="hover:text-pure-white transition-colors">
                  Contact Us
                </a>
              </li>
              <li>
                <a href="#privacy" className="hover:text-pure-white transition-colors">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="#terms" className="hover:text-pure-white transition-colors">
                  Terms of Service
                </a>
              </li>
              <li>
                <a href="#faq" className="hover:text-pure-white transition-colors">
                  FAQs
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-pure-white transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            ...
            <span className="text-gray-400 text-sm">SSL Secured & PCI Compliant</span>
          </div>
        </div>
      </div>
    </footer>
