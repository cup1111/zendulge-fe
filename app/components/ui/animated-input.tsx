...
const AnimatedInput = ({ className, type, validationState = "idle", showValidationIcon = true, animateOnChange = true, ref, ...props }: AnimatedInputProps & { ref?: React.Ref<HTMLInputElement> }) => {
  ...
  const getValidationIcon = () => {
    if (!showValidationIcon || validationState === "idle" || !hasInteracted) return null;
    ...
    <div className="relative">
      <input
        ...
        className={combineClasses(
          ...
          animateOnChange && validationState !== "idle" && hasInteracted && "animate-pulse",
          showValidationIcon && hasInteracted && validationState !== "idle" && "pr-10",
          className
        )}
        ref={ref}
        onFocus={handleFocus}
