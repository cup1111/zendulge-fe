...
const Toast = ({ className, variant, ref, ...props }: React.ComponentPropsWithRef<typeof ToastPrimitives.Root> & VariantProps<typeof toastVariants>) => {
  return (
...
const ToastDescription = ({ className, ref, ...props }: React.ComponentPropsWithRef<typeof ToastPrimitives.Description>) => (
