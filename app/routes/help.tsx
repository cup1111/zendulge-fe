                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="setup">
                    ...
                    <AccordionContent>
                      ...
                      profile, add your services, and start creating deals for
                      your off-peak hours.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="commission">
                    ...
                    <AccordionContent>
                      We charge a small commission on successful bookings. The
                      exact rate depends on your subscription plan and booking
                      volume.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="deals-manage">
                    ...
                    <AccordionContent>
                      Use your business dashboard to create, edit, pause, or
                      delete deals. You can also set automatic scheduling for
                      recurring off-peak slots.
                    </AccordionContent>
                  </AccordionItem>
