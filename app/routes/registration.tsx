...
import { Heart, MapPin, Globe, UserCheck } from 'lucide-react';
...
export default function TestingRegistration({
  type,
}: TestingRegistrationProps) {
...
function CustomerRegistrationFlow({
  step,
  formData,
  onInputChange,
  onNext,
      ...
      <div className='bg-blue-100 border-b border-blue-200 p-4'>
        <div className='max-w-4xl mx-auto'>
          <p className='text-blue-800 text-sm'>
            <strong>Testing Mode:</strong> Customer Registration Process -{' '}
            {currentSection?.title} ({step} of {maxSteps})
          </p>
        </div>
      </div>
        ...
        <div className='bg-white rounded-lg shadow-md p-8'>
          ...
          {step === 2 && (
            <div className='space-y-6'>
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6'>
                <p className='text-blue-800 text-sm'>
                  Contact details for booking confirmations and wellness service
                  communications
                </p>
              </div>
              <div className='space-y-2'>
                ...
                />
                <p className='text-sm text-gray-600'>
                  We'll send booking confirmations and important updates to this
                  number
                </p>
              </div>
            </div>
          ...
          {step === 3 && (
            <div className='space-y-6'>
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6'>
                <p className='text-blue-800 text-sm'>
                  Your address helps us show you relevant deals and services in
                  your area
                </p>
              </div>
              <div className='space-y-2'>
                ...
                />
                <p className='text-sm text-gray-600'>
                  This helps us personalise deals and services in your location
                </p>
              </div>
            </div>
          )}
          ...
          {step === 4 && ( // TODO 使用 enum来判断
            <div className='space-y-6'>
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6'>
                <p className='text-blue-800 text-sm'>
                  Select your wellness interests to receive personalised deal
                  recommendations
                </p>
              </div>
              <div className='space-y-2'>
                ...
                <p className='text-sm text-gray-600'>
                  These help us recommend deals that match your wellness goals
                </p>
              </div>
            </div>
          )}
            ...
            <div className='space-y-6 text-center'>
              ...
              <div className='bg-green-50 border border-green-200 rounded-lg p-6'>
                <p className='text-green-800 mb-4'>
                  <strong>Testing Mode Complete:</strong> In a real scenario,
                  you would now:
                </p>
                <ul className='text-green-700 text-left space-y-2'>
                  <li>• Browse and discover wellness deals in your area</li>
                  <li>
                    • Save your favourite deals and businesses to your wellness
                    favourites
                  </li>
                  <li>
                    • Book appointments with secure Stripe payment processing
                  </li>
                  <li>
                    • Track your wellness journey with comprehensive booking
                    history
                  </li>
                  <li>• Rate and review services to help other customers</li>
                  <li>
                    • Receive personalised deal recommendations based on your
                    interests
                  </li>
                  <li>
                    • Manage your profile and preferences from your account
                    dashboard
                  </li>
                </ul>
              </div>
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='bg-blue-100 border-b border-blue-200 p-4'>
        <div className='max-w-4xl mx-auto'>
          <p className='text-blue-800 text-sm'>
            <strong>Testing Mode:</strong> Business Registration Process -{' '}
            {currentSection?.title} ({step} of {maxSteps})
          </p>
        </div>
      </div>
