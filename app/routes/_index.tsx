...
export default function Landing() {
  ...
  // 使用 mock 数据
  const displayedDeals = showSearchResults
    ? selectedCategory
      ? mockDeals.filter(deal => deal.category.toLowerCase() === selectedCategory.toLowerCase())
      : mockDeals
    : mockDeals.slice(0, 3); // 默认只显示前 3 个
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="text-center mb-8">
            ...
            <div className="max-w-7xl mx-auto mb-10">
              <div className="text-left mb-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Recommended</h2>
              </div>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-pure-white rounded-2xl shadow-xl border-2 border-shadow-lavender overflow-hidden relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-shadow-lavender/5 to-transparent pointer-events-none"></div>
                ...
                <div className="relative p-6 pb-4 bg-gradient-to-r from-pure-white to-frosted-lilac/20">
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-8 gap-4 items-end">
                    ...
                    <div className="xl:col-span-3">
                      <div className="flex items-center mb-3">
                        <h3 className="text-sm font-semibold text-gray-800">Within</h3>
                      </div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Recently Booked</h2>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500 mt-1">{booking.bookedAt}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-900 max-w-3xl mx-auto">
              Get premium wellness services at unbeatable prices during off-peak hours
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-900">
                Save significantly on premium wellness services during off-peak hours
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-900">
                Book your wellness appointment instantly with secure payment processing
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-700 line-clamp-2 mb-3">{deal.description}</p>
