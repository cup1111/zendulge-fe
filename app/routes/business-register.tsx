...
import { Building, Upload, Globe, Facebook, Twitter, Phone, Mail, User, ChevronDown, ChevronRight, CheckCircle, AlertCircle, Building2, MapPin, Hash } from "lucide-react";
...
export default function BusinessRegister() {
  ...
  const getFieldCompletion = (section: keyof typeof sectionsOpen): boolean => {
    ...
    switch (section) {
      ...
      case 'address':
        return !!(values.streetNumber && values.streetName && 
                 values.city && values.postalCode);
      case 'contact':
        return !!(values.phone && values.email);
      case 'contactPerson':
        return !!(values.contactPersonName && values.contactPersonEmail && values.contactPersonPhone);
      case 'branding':
      ...
      <div className="max-w-4xl mx-auto">
                    ...
                    <CardHeader className="cursor-pointer hover:bg-gray-50 transition-colors">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <CardTitle className="text-lg">ABN Information</CardTitle>
                    ...
                    <CardContent className="pt-0 space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-500">
                          Enter your 11-digit ABN. You can look it up at <a href="https://abr.business.gov.au/" target="_blank" rel="noopener noreferrer" className="text-shadow-lavender underline">ABN Lookup</a>
                        </p>
                      </div>

                      {/* ABN Registered Name */}
                      <div className="space-y-2">
                        <Label htmlFor="abnRegisteredName">ABN Registered Business Name *</Label>
                        <Input
                        ...
                        {form.formState.errors.abnRegisteredName && (
                          <p className="text-sm text-red-500">{form.formState.errors.abnRegisteredName.message}</p>
                        )}
                        <p className="text-xs text-gray-500">
                    ...
                    <CardContent className="pt-0 space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        {form.formState.errors.contactPersonPhone && (
                          <p className="text-sm text-red-500">{form.formState.errors.contactPersonPhone.message}</p>
                        )}
                      </div>
                    </CardContent>
                  </CollapsibleContent>
                  ...
                  <CollapsibleTrigger className="w-full">
                    <CardHeader className="cursor-pointer hover:bg-gray-50 transition-colors">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <Building className="w-5 h-5 text-shadow-lavender" />
                          <CardTitle className="text-lg">Branding (Optional)</CardTitle>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
          <p className="text-sm text-blue-800 text-center">
            <strong>Demo Mode:</strong> This is a visual demonstration. No data will be saved.
          </p>
        </div>
      </div>
    </div>
