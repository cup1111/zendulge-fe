                ...
                <div className="space-y-3">
                  ...
                  {user.role === 'business' && (
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      {user.businessesCount} Business{user.businessesCount !== 1 ? 'es' : ''}
                    </div>
                  )}
                </div>
                        ...
                        {isEditing ? (
                          ...
                          <div className="py-2">
                            {user.interests && user.interests.length > 0 ? (
                              ...
                              <p className="text-sm text-gray-500">No wellness interests selected</p>
                            )}
                          </div>
                        )}
                      </div>
                  ...
                  <CardContent>
                    {businesses.length > 0 ? (
                        ...
                        {businesses.map((business) => (
                          <div key={business.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <Badge variant={business.isActive ? "default" : "secondary"} className={business.isActive ? "bg-green-100 text-green-700" : ""}>
                            ...
                            <div className="flex gap-6 mt-3 pt-3 border-t">
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  <div className="text-sm font-semibold">${business.totalRevenue.toLocaleString()}</div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  <div className="text-sm font-semibold">{business.totalBookings}</div>
                                  <div className="text-xs text-gray-600">Bookings</div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="text-center py-8">
                        ...
                        <h3 className="font-semibold text-gray-600 mb-2">No businesses registered</h3>
                        <p className="text-gray-500 text-sm mb-4">
                          Register your business to start offering deals on the platform.
                        </p>
